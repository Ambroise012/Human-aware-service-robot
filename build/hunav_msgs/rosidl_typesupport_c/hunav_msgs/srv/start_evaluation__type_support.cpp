...
static const _StartEvaluation_Request_type_support_symbol_names_t _StartEvaluation_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hunav_msgs, srv, StartEvaluation_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hunav_msgs, srv, StartEvaluation_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hunav_msgs, srv, StartEvaluation_Request)() {
  return &::hunav_msgs::srv::rosidl_typesupport_c::StartEvaluation_Request_message_type_support_handle;
}
...
static const _StartEvaluation_Response_type_support_symbol_names_t _StartEvaluation_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hunav_msgs, srv, StartEvaluation_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hunav_msgs, srv, StartEvaluation_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hunav_msgs, srv, StartEvaluation_Response)() {
  return &::hunav_msgs::srv::rosidl_typesupport_c::StartEvaluation_Response_message_type_support_handle;
}
...
static const _StartEvaluation_type_support_symbol_names_t _StartEvaluation_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hunav_msgs, srv, StartEvaluation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hunav_msgs, srv, StartEvaluation)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, hunav_msgs, srv, StartEvaluation)() {
  return &::hunav_msgs::srv::rosidl_typesupport_c::StartEvaluation_service_type_support_handle;
}
