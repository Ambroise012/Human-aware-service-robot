...
#include "hunav_msgs/msg/detail/agents__rosidl_typesupport_fastrtps_c.h"
...
#include "hunav_msgs/msg/detail/agent__functions.h"  // agents
...
using _Agents__ros_msg_type = hunav_msgs__msg__Agents;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Agents__ros_msg_type * ros_message = static_cast<const _Agents__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Agents__ros_msg_type * ros_message = static_cast<_Agents__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: agents
  {
    ...
    if (ros_message->agents.data) {
      hunav_msgs__msg__Agent__Sequence__fini(&ros_message->agents);
    }
    if (!hunav_msgs__msg__Agent__Sequence__init(&ros_message->agents, size)) {
...
static uint32_t _Agents__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hunav_msgs__msg__Agents(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hunav_msgs__msg__Agents;
    is_plain =
      (
...
static size_t _Agents__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hunav_msgs__msg__Agents(
...
static message_type_support_callbacks_t __callbacks_Agents = {
  "hunav_msgs::msg",
  "Agents",
...
static rosidl_message_type_support_t _Agents__type_support = {
