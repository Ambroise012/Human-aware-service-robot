...
#include "hunav_msgs/srv/detail/get_parameters__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hunav_msgs::srv::GetParameters_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hunav_msgs::srv::GetParameters_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hunav_msgs::srv::GetParameters_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hunav_msgs::srv::GetParameters_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hunav_msgs::srv::GetParameters_Request *>(
    untyped_ros_message);
...
{
  return &hunav_msgs::srv::typesupport_fastrtps_cpp::_GetParameters_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hunav_msgs, srv, GetParameters_Request)() {
  return &hunav_msgs::srv::typesupport_fastrtps_cpp::_GetParameters_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_hunav_msgs
cdr_serialize(
  const hunav_msgs::srv::GetParameters_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.map;
  // Member: simulator
  cdr << ros_message.simulator;
  // Member: yaml_base_name
  cdr << ros_message.yaml_base_name;
  // Member: goal_ids
  {
    cdr << ros_message.goal_ids;
  }
  // Member: goal_x_coords
  {
    cdr << ros_message.goal_x_coords;
  }
  // Member: goal_y_coords
  {
    cdr << ros_message.goal_y_coords;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hunav_msgs::srv::GetParameters_Response & ros_message)
{
  // Member: publish_people
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  // Member: goal_ids
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.goal_ids[0]);
  ...
  // Member: goal_x_coords
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.goal_x_coords[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: goal_y_coords
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.goal_y_coords[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = hunav_msgs::srv::GetParameters_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hunav_msgs::srv::GetParameters_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<hunav_msgs::srv::GetParameters_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &hunav_msgs::srv::typesupport_fastrtps_cpp::_GetParameters_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hunav_msgs, srv, GetParameters_Response)() {
  return &hunav_msgs::srv::typesupport_fastrtps_cpp::_GetParameters_Response__handle;
}
...
{
  return &hunav_msgs::srv::typesupport_fastrtps_cpp::_GetParameters__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hunav_msgs, srv, GetParameters)() {
  return &hunav_msgs::srv::typesupport_fastrtps_cpp::_GetParameters__handle;
}
