...
#include "people_msgs/msg/detail/person__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // name, tagnames, tags
#include "rosidl_runtime_c/string_functions.h"  // name, tagnames, tags
...
using _Person__ros_msg_type = people_msgs__msg__Person;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: tagnames
  {
    size_t size = ros_message->tagnames.size;
    auto array_ptr = ros_message->tagnames.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: tagnames
  {
    ...
    if (ros_message->tagnames.data) {
      rosidl_runtime_c__String__Sequence__fini(&ros_message->tagnames);
    }
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->tagnames, size)) {
      fprintf(stderr, "failed to create array for field 'tagnames'");
      return false;
    }
    auto array_ptr = ros_message->tagnames.data;
    for (size_t i = 0; i < size; ++i) {
      ...
      bool succeeded = rosidl_runtime_c__String__assign(
        ...
        tmp.c_str());
      if (!succeeded) {
        fprintf(stderr, "failed to assign string into field 'tagnames'\n");
        return false;
      }
    }
  }
...
static uint32_t _Person__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_people_msgs__msg__Person(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = people_msgs__msg__Person;
    is_plain =
      (
...
static size_t _Person__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_people_msgs__msg__Person(
